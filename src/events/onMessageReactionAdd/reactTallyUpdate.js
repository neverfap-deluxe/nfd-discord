...
// );
const message50 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 50 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message150 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 150 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message250 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 250 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message350 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 350 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message450 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 450 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message550 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 550 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
...
const message650 = (discordUser, accountabilityChannel, hoursTillCountdown) => new RichEmbed().setTitle(`We just hit 650 emoji reacts for today! Only ${hoursTillCountdown} to go!`).setDescription(
