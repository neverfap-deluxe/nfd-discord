...
const twelveHoursBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 12 hours until the final countdown!").setDescription(
...
const oneFourHoursBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 4 hours until the final countdown!").setDescription(
...
const oneTwoHoursBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 2 hours until the final countdown!").setDescription(
  `The ${milestoneChannel} tally ends in approximately 2 hours! Get ready to feel the awe of ${accountabilityChannel}! :boom:`
);
const oneHourBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 1 hour until the final countdown!").setDescription(
  `Only one hour to go till the BIG POP! Get your ${accountabilityChannel} posts in if you haven't yet already! :grin:`
);
const thirtyMinutesBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 30 minutes until the final countdown!").setDescription(
...
const fiveMinutesBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 5 minutes until the final countdown!").setDescription(
...
const oneMinuteBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("Only 1 minute until the final countdown!").setDescription(
