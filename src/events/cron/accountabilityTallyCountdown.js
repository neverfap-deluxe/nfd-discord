...
const fiveMinutesBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("#daily-milestones 5 minute countdown!").setDescription(
...
const oneMinuteBeforeMessage = (accountabilityChannel, milestoneChannel) => new RichEmbed().setTitle("#daily-milestones 1 minute countdown!").setDescription(
