...
const generalMessage2  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage3  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage4  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage5  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage6  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage7  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage8  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage9  = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage10 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage11 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage12 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `Porn is not a solution to your problems. It never has been and it never will be. :fearful:`);
const generalMessage13 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage14 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage15 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage16 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage17 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage18 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage19 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `You can't force self-control, however you can make it very easy to be in-control by letting go and remaining calm. :smile:`);
const generalMessage20 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage21 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage22 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `When you neglect the process, you neglect yourself. You distrust the process, you lose. It's that le simple! :bread:`);
const generalMessage23 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage24 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `Blame isn’t a constructive method of self-improvement. Processes on the other hand are. :date:`);
const generalMessage25 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `Cravings don’t just appear out of thin air. Cravings are the result of an uncalm mind. :sweat:`);
const generalMessage26 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage27 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage28 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage29 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
  `Make it your mission throughout the day to remain calm and collected. Oh, and deliriously sexy as well. :herb:`);
const generalMessage30 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage31 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage32 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage33 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const generalMessage34 = () => new RichEmbed().setTitle("#recovery advice").setDescription(
...
const automatedGeneralMessages = async (client, logger, juliusReade) => {
  try {
    ...
    if (lastMessageID) {
      const lastMessage = await recoveryChannel.fetchMessage(lastMessageID);
      if (_.get(lastMessage, 'author.id') !== process.env.NEVERFAP_DELUXE_BOT_ID) {
        const count = generateRandomNumber(1, 34);
        automatedGeneralSwitch(recoveryChannel, count, logger);
        // const countTwo = generateRandomNumber(1, 34);
        // automatedGeneralSwitch(randomChannel, countTwo, logger);
      }
    }
  } catch(error) {
...
const automatedGeneralSwitch = async (channel, count, logger) => {
  switch(count) {
    case 1: {
