...
const HELP_COMMAND_DESCRIPTION = 'display a list of all NeverFap Deluxe Bot commands.';
const CHANNELS_COMMAND_DESCRIPTION = 'understand all the different channels.';
